...
def get_fwd_prefill_configs(autotune: bool):
    ...
    if not autotune:
        ...
        if arch.name == "gfx950":
        ...
        elif arch.name == "gfx906":
            # Vega 20 (gfx906) – limited SRAM and smaller optimal block size
            return [
                triton.Config(
                    {
                        "BLOCK_M": 64,
            ...
            # Generic fallback for unknown / legacy architectures
            # (e.g. gfx900 Vega 10, gfx101x RDNA1)
            return [
                triton.Config(
                    {
                        "BLOCK_M": 64,
